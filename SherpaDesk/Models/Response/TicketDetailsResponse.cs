...
{
    [DataContract]
    public class TicketDetailsResponse : TicketBaseResponse
    {
        [DataMember(Name = "id"), Details]
        public int TicketId { get; set; }

        [DataMember(Name = "initial_post"), Details]
        public string InitialPost { get; set; }

        [DataMember(Name = "workpad"), Details]
